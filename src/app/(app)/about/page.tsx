...
export default function AboutPage() {
  return (
    <div className="mx-auto flex w-full max-w-3xl flex-col gap-16 md:gap-20">
      ...
      <section className="flex flex-col gap-4 border-t border-zinc-900 pt-10">
      ...
      <div className="flex flex-wrap items-center gap-3 border-t border-zinc-900 pt-10">
        <LinkButton href="/open-pack" variant="primary" className="h-11 px-6">
          Open a pack
        </LinkButton>
        <Link
          href="/sets"
          className="text-sm font-medium text-zinc-500 underline underline-offset-4 hover:text-white"
        >
          Browse sets
        </Link>
      </div>
